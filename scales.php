...
function getScales(): array {
    return [
        ...
        'ISI' => [
            'name'        => 'ISI',
            'full_name'   => '불면증 심각도 지수 (ISI: Insomnia Severity Index)',
            'category'    => '수면',
            'period'      => '최근 2주간',
            'layout'      => 'segment',
            'instruction' => '최근 2주간 당신의 수면 문제에 대한 질문입니다. 각 문항에서 자신에게 가장 잘 맞는 정도를 하나 선택해 주세요.',
            'options'       => ['없다', '약간', '중간 정도', '심하다', '매우 심하다'],
            'option_values' => [0, 1, 2, 3, 4],
            'questions'   => [
                '잠들기 어렵다. (입면의 어려움)',
                '잠을 유지하기 어렵다. (수면 유지의 어려움)',
                '너무 일찍 깬다. (조기 각성)',
                '현재 수면 양상에 대해 얼마나 만족 또는 불만족하십니까?',
                '당신의 수면 문제가 낮 활동(피로감, 업무·가사 능력, 집중력, 기억력, 기분 등)을 어느 정도 방해한다고 생각합니까?',
                '당신의 수면 문제로 인한 삶의 질 저하가 다른 사람들에게 어느 정도로 드러난다고 생각합니까?',
                '현재 당신의 수면 문제에 대해 얼마나 걱정하고 있습니까?',
            ],
            // 문항별 보기 문안 — 값(0~4)은 동일하고 표시 문구만 문항에 맞게 다름
            'question_options' => [
                3 => ['매우 만족', '약간 만족', '그저 그렇다', '약간 불만족', '매우 불만족'],
                4 => ['전혀 방해 안 됨', '약간', '다소', '상당히', '매우 많이'],
                5 => ['전혀 드러나지 않음', '약간', '다소', '상당히', '매우 심하게'],
                6 => ['전혀 걱정 안 됨', '약간', '다소', '상당히', '매우 많이'],
            ],
            'scoring' => [
                ['min' => 0,  'max' => 7,  'label' => '유의한 불면 없음',   'color' => 'green'],
                ['min' => 8,  'max' => 14, 'label' => '약간의 불면(역치하)', 'color' => 'yellow'],
                ['min' => 15, 'max' => 21, 'label' => '중등도 임상적 불면',  'color' => 'orange'],
                ['min' => 22, 'max' => 28, 'label' => '심한 임상적 불면',    'color' => 'black'],
            ],
            'cutoff'     => 15,   // 15점 이상: 임상적 불면증 시사(선별 절단점)
            'max_score'  => 28,
            'note'       => '7개 문항, 각 0~4점, 총 0~28점. 15점 이상이면 임상적 불면증을 시사합니다(선별 목적이며 진단은 임상 면담으로 확정). 문항·보기 문안은 원광대학교 한방병원 한방신경정신과 심리검사 매뉴얼(26.09.03)을 따릅니다.',
            'source'     => 'Morin CM(1993); Bastien CH 외(2001) Sleep Med. 한국어판 사용 시 저작권 확인 권장.',
        ],
    ];
}
